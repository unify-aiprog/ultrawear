...
const emptyProgramme: SportsProgramme = {
  ...
  editorial: {
    ...
    headline: 'Stay close to sport.',
    body: 'The live programme is waiting for its first verified refresh.',
  },
};
  ...
  return (
    <div className="page-wrap">
      <section className="page-hero">
        ...
        {stored && (
          <output className="live-refresh-note">
            {stale
              ? 'LAST TRUSTED PROGRAMME IS STALE — awaiting a verified refresh.'
              : `LAST VERIFIED · ${formatUpdatedAt(stored.updatedAt)}`}
          </output>
        )}
      </section>
